...
func NewFileIngestEvent(objectIdentifier, fileIdentifier string, storedAt time.Time, md5Digest, _uuid string) (*PremisEvent, error) {
	if objectIdentifier == "" {
		return nil, fmt.Errorf("Param objectIdentifier cannot be empty.")
	}
	if fileIdentifier == "" {
		return nil, fmt.Errorf("Param fileIdentifier cannot be empty.")
	}
	if storedAt.IsZero() {
	...
	return &PremisEvent{
		...
		IntellectualObjectIdentifier: objectIdentifier,
...
func NewFileFixityCheckEvent(objectIdentifier, fileIdentifier string, checksumVerifiedAt time.Time, fixityAlg, digest string, fixityMatched bool) (*PremisEvent, error) {
	if objectIdentifier == "" {
		return nil, fmt.Errorf("Param objectIdentifier cannot be empty.")
	}
	if fileIdentifier == "" {
...
func NewFileDigestEvent(objectIdentifier, fileIdentifier string, checksumGeneratedAt time.Time, fixityAlg, digest string) (*PremisEvent, error) {
	if objectIdentifier == "" {
		return nil, fmt.Errorf("Param objectIdentifier cannot be empty.")
	}
	if fileIdentifier == "" {
...
func NewFileIdentifierEvent(objectIdentifier, fileIdentifier string, identifierGeneratedAt time.Time, identifierType, identifier string) (*PremisEvent, error) {
	if objectIdentifier == "" {
		return nil, fmt.Errorf("Param objectIdentifier cannot be empty.")
	}
	if fileIdentifier == "" {
...
func NewFileReplicationEvent(objectIdentifier, fileIdentifier string, replicatedAt time.Time, replicationUrl string) (*PremisEvent, error) {
	if objectIdentifier == "" {
		return nil, fmt.Errorf("Param objectIdentifier cannot be empty.")
	}
	if fileIdentifier == "" {
