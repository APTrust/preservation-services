...
type TransferObject struct {
	...
	// storage locations.
	SourceStorageOption string `json:"source_storage_option"`

	TargetStorageOption string `json:"target_storage_option"`
...
func NewTransferObject(s3Bucket, s3Key, eTag, institution string, institutionID, size int64) *TransferObject {
	return &TransferObject{
		...
		SourceStorageOption:       constants.StorageStandard,
		TagFiles:                  make([]string, 0),
		TagManifests:              make([]string, 0),
		Tags:                      make([]*bagit.Tag, 0),
		TargetStorageOption:       constants.StorageGlacierVA,
	}
}

// TransferObjectFromJSON converts the JSON representation of an IngestObject
// to an actual object.
func TransferObjectFromJSON(jsonData string) (*TransferObject, error) {
	obj := &TransferObject{}
...
func (obj *TransferObject) ToJSON() (string, error) {
...
func (obj *TransferObject) Identifier() string {
...
func (obj *TransferObject) FileIdentifier(filename string) string {
...
// specified name.
func (obj *TransferObject) GetTags(tagFile, tagName string) []*bagit.Tag {
	tags := make([]*bagit.Tag, 0)
...
// specified name.
func (obj *TransferObject) GetTag(tagFile, tagName string) *bagit.Tag {
	var tag *bagit.Tag
...
func (obj *TransferObject) GetTagValue(tagFile, tagName, defaultValue string) string {
	value := defaultValue
...
func (obj *TransferObject) BagItProfileFormat() string {
...
func (obj *TransferObject) Access() string {
...
func (obj *TransferObject) AltIdentifier() string {
...
func (obj *TransferObject) BagGroupIdentifier() string {
...
func (obj *TransferObject) BagItProfileIdentifier() string {
...
func (obj *TransferObject) Description() string {
...
func (obj *TransferObject) InternalSenderDescription() string {
...
// bag-info.txt file.
func (obj *TransferObject) SourceOrganization() string {
...
func (obj *TransferObject) Title() string {
...
func (obj *TransferObject) BestAvailableDescription() string {
...
// Registry.
func (obj *TransferObject) ToIntellectualObject() *registry.IntellectualObject {
	return &registry.IntellectualObject{
		...
		StorageOption:             obj.TargetStorageOption,
		Title:                     obj.Title(),
	}
}
...
func (obj *TransferObject) GetIngestEvents() []*registry.PremisEvent {
...
func (obj *TransferObject) initIngestEvents() {
...
func (obj *TransferObject) NewObjectCreationEvent() *registry.PremisEvent {
	eventId := uuid.New()
...
func (obj *TransferObject) NewObjectIngestEvent() *registry.PremisEvent {
	eventId := uuid.New()
	timestamp := time.Now().UTC()
	return &registry.PremisEvent{
		Identifier:           eventId.String(),
...
// time an object is ingested, but not when it is updated.
func (obj *TransferObject) NewObjectIdentifierEvent() *registry.PremisEvent {
	eventId := uuid.New()
	timestamp := time.Now().UTC()
	return &registry.PremisEvent{
		Identifier:           eventId.String(),
...
func (obj *TransferObject) NewObjectRightsEvent() *registry.PremisEvent {
	eventId := uuid.New()
	timestamp := time.Now().UTC()
	return &registry.PremisEvent{
		Identifier:           eventId.String(),
