...
var transferEtag = "12345678"
var transferObjIdentifier = "test.edu/test-bag"
var transferInstIdentifier = "test.edu"
var transferInstitutionId = int64(9855)
var transferBucket = "bucket"
var transferS3Key = "test-bag.b001.of200.tar"

var transferInternalSenderIdentifier = "Wile E. Coyote"
var transferBagGroupIdentifier = "Road Runner"
var transferSourceOrganization = "Acme Corp."
var transferTitle = "Title of Object"
var transferDescription = "Description of Object"
var transferInternalDescription = "Description of Object (Internal Sender Description)"
var transferExternalDescription = "Description of Object (External Description)"
var transferExternalIdentifier = "ext-identifier"
var transferInternalIdentifier = "int-identifier"

func getTransferObjectWithTags() *service.IngestObject {
...
func TestNewTransferObject(t *testing.T) {
...
func TestTransferObjectBagName(t *testing.T) {
	obj := service.NewIngestObject(bucket, s3Key, etag, instIdentifier, institutionId, int64(500))
...
func TestTransferBaseNameOfS3Key(t *testing.T) {
	obj := service.NewIngestObject(bucket, s3Key, etag, instIdentifier, institutionId, int64(500))
...
func TestTransferObjectIdentifier(t *testing.T) {
	obj := service.NewIngestObject(bucket, s3Key, etag, instIdentifier, institutionId, int64(500))
	assert.Equal(t, objIdentifier, obj.Identifier())
...
func TestTransferObjFromJson(t *testing.T) {
...
func TestTransferObjToJson(t *testing.T) {
	obj := testutil.GetIngestObject()
	data, err := obj.ToJSON()
	assert.Nil(t, err)
...
func TestTransferGetTags(t *testing.T) {
...
func TestTransferGetTag(t *testing.T) {
	obj := getObjectWithTags()
...
func TestTransferBagItProfileFormat(t *testing.T) {
	obj := testutil.GetIngestObject()
...
func TestTransferGetTagValue(t *testing.T) {
	obj := getObjectWithTags()
...
func TestTransferAltIdentifier(t *testing.T) {
	obj := getObjectWithTags()
	assert.Equal(t, internalSenderIdentifier, obj.AltIdentifier())
}

func TestTransferBagGroupIdentifier(t *testing.T) {
	obj := getObjectWithTags()
	assert.Equal(t, bagGroupIdentifier, obj.BagGroupIdentifier())
}

func TestTransferBagItProfileIdentifier(t *testing.T) {
	obj := getObjectWithTags()
...
func TestTransferBestAvailableDescription(t *testing.T) {
	obj := getObjectWithTags()
...
func TestTransferToIntellectualObject(t *testing.T) {
	obj := getObjectWithTags()
...
func TestNewTransferObjectCreationEvent(t *testing.T) {
	obj := getObjectWithTags()
...
func TestNewTransferObjectIngestEvent(t *testing.T) {
	obj := getObjectWithTags()
...
func TestNewTransferObjectIdentifierEvent(t *testing.T) {
	obj := getObjectWithTags()
...
func TestNewTransferObjectRightsEvent(t *testing.T) {
	obj := getObjectWithTags()
