...
func TestNewFileIngestEvent(t *testing.T) {
	...
	assert.Equal(t, constants.EventObjectPreMinio, event.Object)
...
func TestNewFileFixityCheckEvent(t *testing.T) {
	...
	assert.Equal(t, constants.StatusSuccess, event.Outcome)
	assert.Equal(t, "md5:5555", event.OutcomeDetail)
	assert.Equal(t, constants.EventObjectMD5, event.Object)
	assert.Equal(t, eObjIdent, event.IntellectualObjectIdentifier)
	assert.Equal(t, constants.EventAgentMD5, event.Agent)
...
func TestNewFileDigestEvent(t *testing.T) {
	...
	assert.Equal(t, constants.EventObjectSHA256, event.Object)
	assert.Equal(t, eObjIdent, event.IntellectualObjectIdentifier)
	assert.Equal(t, constants.EventAgentSHA256, event.Agent)
...
func TestNewFileIdentifierEvent(t *testing.T) {
	...
	assert.Equal(t, constants.EventObjectExchange, event.Object)
	assert.Equal(t, eObjIdent, event.IntellectualObjectIdentifier)
	...
	assert.Equal(t, constants.EventObjectUUIDMinio, event.Object)
	assert.Equal(t, eObjIdent, event.IntellectualObjectIdentifier)
	assert.Equal(t, constants.EventAgentUUID, event.Agent)
