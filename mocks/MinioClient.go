...
func (_m *MinioClient) AbortMultipartUpload(bucket string, object string, uploadID string) error {
...
func (_m *MinioClient) AbortMultipartUploadWithContext(ctx context.Context, bucket string, object string, uploadID string) error {
...
func (_m *MinioClient) CompleteMultipartUpload(bucket string, object string, uploadID string, parts []minio.CompletePart) (string, error) {
...
func (_m *MinioClient) CompleteMultipartUploadWithContext(ctx context.Context, bucket string, object string, uploadID string, parts []minio.CompletePart) (string, error) {
...
func (_m *MinioClient) CopyObject(sourceBucket string, sourceObject string, destBucket string, destObject string, metadata map[string]string) (minio.ObjectInfo, error) {
...
func (_m *MinioClient) CopyObjectPart(srcBucket string, srcObject string, destBucket string, destObject string, uploadID string, partID int, startOffset int64, length int64, metadata map[string]string) (minio.CompletePart, error) {
...
func (_m *MinioClient) CopyObjectPartWithContext(ctx context.Context, srcBucket string, srcObject string, destBucket string, destObject string, uploadID string, partID int, startOffset int64, length int64, metadata map[string]string) (minio.CompletePart, error) {
...
func (_m *MinioClient) CopyObjectWithContext(ctx context.Context, sourceBucket string, sourceObject string, destBucket string, destObject string, metadata map[string]string) (minio.ObjectInfo, error) {
...
func (_m *MinioClient) GetBucketPolicy(bucket string) (string, error) {
...
func (_m *MinioClient) GetObject(bucketName string, objectName string, opts minio.GetObjectOptions) (io.ReadCloser, minio.ObjectInfo, http.Header, error) {
	ret := _m.Called(bucketName, objectName, opts)

	var r0 io.ReadCloser
	if rf, ok := ret.Get(0).(func(string, string, minio.GetObjectOptions) io.ReadCloser); ok {
	...
	if rf, ok := ret.Get(1).(func(string, string, minio.GetObjectOptions) minio.ObjectInfo); ok {
	...
	var r2 http.Header
	if rf, ok := ret.Get(2).(func(string, string, minio.GetObjectOptions) http.Header); ok {
		r2 = rf(bucketName, objectName, opts)
	} else {
		if ret.Get(2) != nil {
	...
	var r3 error
	if rf, ok := ret.Get(3).(func(string, string, minio.GetObjectOptions) error); ok {
		r3 = rf(bucketName, objectName, opts)
	} else {
		r3 = ret.Error(3)
	}
...
func (_m *MinioClient) GetObjectWithContext(ctx context.Context, bucketName string, objectName string, opts minio.GetObjectOptions) (io.ReadCloser, minio.ObjectInfo, http.Header, error) {
...
func (_m *MinioClient) ListMultipartUploads(bucket string, prefix string, keyMarker string, uploadIDMarker string, delimiter string, maxUploads int) (minio.ListMultipartUploadsResult, error) {
...
func (_m *MinioClient) ListObjectParts(bucket string, object string, uploadID string, partNumberMarker int, maxParts int) (minio.ListObjectPartsResult, error) {
...
func (_m *MinioClient) ListObjects(bucket string, prefix string, marker string, delimiter string, maxKeys int) (minio.ListBucketResult, error) {
...
func (_m *MinioClient) ListObjectsV2(bucketName string, objectPrefix string, continuationToken string, fetchOwner bool, delimiter string, maxkeys int, startAfter string) (minio.ListBucketV2Result, error) {
...
func (_m *MinioClient) NewMultipartUpload(bucket string, object string, opts minio.PutObjectOptions) (string, error) {
...
func (_m *MinioClient) PutBucketPolicy(bucket string, bucketPolicy string) error {
...
func (_m *MinioClient) PutBucketPolicyWithContext(ctx context.Context, bucket string, bucketPolicy string) error {
...
func (_m *MinioClient) PutObject(bucket string, object string, data io.Reader, size int64, md5Base64 string, sha256Hex string, metadata map[string]string, sse encrypt.ServerSide) (minio.ObjectInfo, error) {
...
func (_m *MinioClient) PutObjectPart(bucket string, object string, uploadID string, partID int, data io.Reader, size int64, md5Base64 string, sha256Hex string, sse encrypt.ServerSide) (minio.ObjectPart, error) {
...
func (_m *MinioClient) PutObjectPartWithContext(ctx context.Context, bucket string, object string, uploadID string, partID int, data io.Reader, size int64, md5Base64 string, sha256Hex string, sse encrypt.ServerSide) (minio.ObjectPart, error) {
...
func (_m *MinioClient) PutObjectWithContext(ctx context.Context, bucket string, object string, data io.Reader, size int64, md5Base64 string, sha256Hex string, metadata map[string]string, sse encrypt.ServerSide) (minio.ObjectInfo, error) {
...
func (_m *MinioClient) StatObject(bucketName string, objectName string, opts minio.StatObjectOptions) (minio.ObjectInfo, error) {
	ret := _m.Called(bucketName, objectName, opts)
...
func (_m *MinioClient) StatObjectWithContext(ctx context.Context, bucketName string, objectName string, opts minio.StatObjectOptions) (minio.ObjectInfo, error) {
	ret := _m.Called(ctx, bucketName, objectName, opts)
